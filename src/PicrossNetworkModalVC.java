...
public class PicrossNetworkModalVC extends JDialog
{
    ...
    **/
    public PicrossNetworkModalVC(JFrame mainView)
    {
        ...
        innerPanel.setBackground(color3);
        outerPanel.setBackground(color2);
        ...
        addrError.setForeground(color1);
        nameError.setForeground(color1);
        portError.setForeground(color1);
        
        //The dialog itself needs a border to help separate it from the normal game UI.
        outerPanel.setBorder(BorderFactory.createMatteBorder(5,5,5,5,color4));
    ...
    */
    ...
    private void hideModal()
    {
        ...
        //I've intentionally not done this, because I want you to. Its worth points to you.
        setVisible(false);
    ...
    */
    ...
    public void PiccrossNetworkModalVC() {
    }

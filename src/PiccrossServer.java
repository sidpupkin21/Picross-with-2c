...
public class PiccrossServer {
    ...
    ArrayList<PiccrossServerClient> clientList; //arraylist to store clients
     ...
     */
    public PiccrossServer(int portNum) {
        this.clientList = new ArrayList<PiccrossServerClient>(); //Array list of PiccrossServerClient
    ...
    public static void main(String[] args){
        while(true) {
            ...
            new PiccrossServer(portNum).startServer();
        }
        ...
        try {
            ...
            try {
                do {
                    ...
                    PiccrossServerClient psc = new PiccrossServerClient(newSock, getClient);
    ...
    public void sendClient(String s) {
        for(PiccrossServerClient psc: this.clientList){
     ...
     */
    public void sendChatToClient(String s, PiccrossServerClient p){
        for(PiccrossServerClient psc:this.clientList){
     ...
     */
    public void disconnectClient(PiccrossServerClient psc){
